...
while True:
    ...
    if ((matrix[0][0] + matrix[0][1] + matrix[0][2]).count(step * 3) +
            (matrix[1][0] + matrix[1][1] + matrix[1][2]).count(step * 3) +
            (matrix[2][0] + matrix[2][1] + matrix[2][2]).count(step * 3) +
            ...
            (matrix[0][2] + matrix[1][2] + matrix[2][2]).count(step * 3)) == 1:  # check for winner
        print(f"{step} wins")
        break
